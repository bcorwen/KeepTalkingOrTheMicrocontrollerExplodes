...
//======================================================================
//
//  Module: The Keypad module (Slave, Standard, Vanilla)
//  version 0.6.1
//
//  Version goals: Object-oriented implementation of Keypad logic
//
//======================================================================
...
void gameReset() {
  ...
  keypad.reset(); // Is this needed if reset is done before game gen?
  // manual_blink = false;
...
void gameRunning() {
  ...
  while (gamemode == 3) {
    ...
    if (!module_defused) {
      ...
      inputCheck();
      /* Defuse check */
      module_defused = keypad.isDefused();
      /* Output update */
      keypad.update();
      leds[1].update();
    }
