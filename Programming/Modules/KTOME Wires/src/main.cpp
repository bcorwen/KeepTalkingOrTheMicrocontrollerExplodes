...
//======================================================================
//
//  Module: The Wires module (Slave, Standard, Vanilla)
//  version 0.6.1
//
//  Version goals: Object-oriented implementation of Wires logic
//
//======================================================================
...
void setup() {
    ...
    Serial.begin(115200);
    while (!Serial);
    Serial.println("== KTOME: Module (Wires) ==");
...
void gameReset() {
    ...
    wires.reset(); // Is this needed if reset is done before game gen?
    // manual_blink = false;
...
void gameRunning() {
    ...
    while (gamemode == 3) {
        ...
        inputCheck();
        /* Defuse check */
        module_defused = wires.isDefused();
        /* Output update */
        // wires.update();
        leds[1].update();
        // }
